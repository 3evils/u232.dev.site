...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['recommended_torrents'])) $setbits_index_page|= block_index::RECOMMENDED;
    else $clrbits_index_page|= block_index::RECOMMENDED;
    //==Stdhead
...
$checkbox_index_recommended = ((curuser::$blocks['index_page'] & block_index::RECOMMENDED) ? ' checked="checked"' : '');
//==Stdhead
...
$HTMLOUT.= '<tr class="userblock"><td><b>'.$lang['user_b_actu1'].'</b></td><td>
    ...
    <div class="checkbox-inline"><label><input data-toggle="toggle" type="checkbox" id="torrentfreak" name="torrentfreak" value="yes"' . $checkbox_index_torrentfreak . '>
        ...
        <tr class="userblock"><td><b>'.$lang['user_b_rector1'].'</b></td><td>
        <div class="checkbox-inline"><label><input data-toggle="toggle" type="checkbox" id="index_recommended_torrents" name="recommended_torrents" value="yes"' . $checkbox_index_recommended . '><label for="index_recommended_torrents">
    </label><span>'.$lang['user_b_chk'].''.$lang['user_b_rector2'].'</span></div>
        </td>
        </tr>
    </table>         
