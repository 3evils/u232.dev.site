...
function showold()
{
	...
	document.getElementById('oldlink').style.background="#ddd";
...
function shownew()
{
	...
	document.getElementById('newlink').style.background="#ddd";
	document.getElementById('bothlink').style.background="";
}
...
function showboth()
{
	...
	document.getElementById('oldlink').style.background="";
	document.getElementById('newlink').style.background="";
	document.getElementById('bothlink').style.background="#ddd";
}
