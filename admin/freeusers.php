...
if ($remove) {
    ...
    $res = sql_query("SELECT id, username, class, can_leech, privacy, ip, torrent_pass FROM users WHERE free_switch != 0 AND id = " . sqlesc($remove)) or sqlerr(__file__, __line__);
