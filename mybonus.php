...
$HTMLOUT .="<div class='card'>
	<div class='card-divider'>
		<h3>{$lang['bonus_success']}</h3>
	</div>".
"<div class='card-section'><img src='{$INSTALLER09['pic_base_url']}/smilies/karma.gif' alt='good_karma' title='{$lang['bonus_goodk']}' /><span class='label label-success'>{$lang['bonus_congrats']}</span>
...
$HTMLOUT .="
	<div class='card'>
		<div class='card-section'><div class='alert alert-success'>{$lang['bonus_congrats']}".format_username($CURUSER) ."{$lang['bonus_3freeslot1']}{$lang['bonus_clickgbs']}<a class='altlink' href='{$INSTALLER09['baseurl']}/mybonus.php'>{$lang['bonus_kbp']}</a>{$lang['bonus_kbpp']}
		</div>
	</div>
</div>";
echo stdhead($CURUSER['username'] . $lang['bonus_user_kmbp'], true, $stdhead) . $HTMLOUT . stdfoot();
...
$HTMLOUT .="<div class='card'>
<div class='card-section'><div class='alert alert-success'>{$lang['bonus_congrats']}".format_username($CURUSER) ." you have got your 100 rep points!
...
$HTMLOUT .="<div class='card'>
<div class='card-section'><div class='alert alert-success'>{$lang['bonus_congrats']}".format_username($CURUSER) ." you have got yourself access to control the site user blocks!
{$lang['bonus_clickgbs']}<a class='altlink' href='{$INSTALLER09['baseurl']}/mybonus.php'>{$lang['bonus_kbp']}</a>{$lang['bonus_kbpp']}</div></div></div>";
echo stdhead($CURUSER['username'] . $lang['bonus_user_kmbp'], true, $stdhead) . $HTMLOUT . stdfoot();
die;
...
$HTMLOUT .="<div class='card'>
<div class='card-section'><div class='alert alert-success'>{$lang['bonus_congrats']}".format_username($CURUSER) ." you have got yourself unlocked bonus moods for use on site!
{$lang['bonus_clickgbs']}<a class='altlink' href='{$INSTALLER09['baseurl']}/mybonus.php'>{$lang['bonus_kbp']}</a>{$lang['bonus_kbpp']}</div></div></div>";
echo stdhead($CURUSER['username'] . $lang['bonus_user_kmbp'] , true, $stdhead) . $HTMLOUT . stdfoot();
die;
...
if(($halfdownload_counter = $mc1->get_value('halfdownload_counter')) === false) {
	...
	if (OCELOT_TRACKER == false) {
		...
		if($freeleech_enabled){
			...
			if($bonus >= $gets['points'] OR $bonus >= $gets['minpoints']) {
				$exchange .="<input class='button success float-right' type='submit' name='submit' value='Exchange!'>";
			}
			else  {
				$exchange .="<p><b>Not Enough Karma</b></p>";
			}
            $contribute = "";
			if($bonus >= $gets['points'] OR $bonus >= $gets['minpoints']) {
				$contribute .="<input class='button success float-right' type='submit' name='submit' value='Contribute!'>";
			}
			else  {
				$contribute .="<p><b>Not Enough Karma</b></p>";
			}
            $k_gift = "";
			if($bonus >= $gets['points'] OR $bonus >= $gets['minpoints']) {
				$k_gift .="<input class='button success float-right' type='submit' name='submit' value='karma Gift!'>";
			}
			else  {
				$k_gift .="<p><b>Not Enough Karma</b></p>";
			}			
  switch (true){
 	case ($gets['id'] == 5):
	...
	<div class='callout'>
			...
			<a data-toggle='collapse".(int)$gets['id']."'>
					<i class='fa fa-info float-right'></i>
				</a>
			</div>
			<div class='reveal' id='collapse".(int)$gets['id']."' data-reveal>
				<form action='{$INSTALLER09['baseurl']}/mybonus.php?exchange=1' method='post'>
					...
					</p>".htmlsafechars($gets['description'])." Enter the <strong>Special Title</strong> you would like to have and click Exchange!</p>
				<div class='input-group callout'>
					<span class='input-group-label'>
						<strong>Cost : </strong>
						<span class='label'>".(float)$gets['points']."</span>
					</span>
					<input class='input-group-field' type='text' name='title' size='30' maxlength='30' />
					<div class='input-group-button'>".$exchange."</div>
				</div>
			</form>
		</div>
	</div>";
  ...
  $HTMLOUT .="<div class='column column-block'>
		...
		<div class='reveal' id='collapse".(int)$gets['id']."' data-reveal>
			<form action='{$INSTALLER09['baseurl']}/mybonus.php?exchange=1' method='post'>
				<input type='hidden' name='option' value='".(int)$gets['id']."'>
				<input type='hidden' name='art' value='".htmlsafechars($gets['art'])."'>
				<p>".htmlsafechars($gets['description'])."</p>
				<p>Enter the <strong>username</strong> of the person you would like to send karma to, and select how many points you want to send and click Exchange!<br></p>
				<p>Min. 1 ->max. 100000.0</p>
				<div class='input-group callout'>
					<input class='input-group-field' type='text' name='username' size='20' maxlength='24'>
					<select class='input-group-field' name='bonusgift'>
					...
					<div class='input-group-button'>".$k_gift."</div>
				</div>			
			</form>
		</div>
	</div>";
  ...
  $HTMLOUT .="<div class='column column-block'>
		<div class='card-divider'>
			<strong>".htmlsafechars($gets['bonusname'])."</strong>
			<a data-open='collapse".(int)$gets['id']."'>
				<i class='fa fa-info float-right'></i>
			</a>
		</div>
		<div class='reveal' id='collapse".(int)$gets['id']."' data-reveal>
			<form action='{$INSTALLER09['baseurl']}/mybonus.php?exchange=1' method='post'>
				<input type='hidden' name='option' value='".(int)$gets['id']."'>
				<input type='hidden' name='art' value='".htmlsafechars($gets['art'])."'>
				<p>".htmlsafechars($gets['description'])." 	Enter the <b>ID number of the Torrent:</b> you would like to buy a 1 to 1 ratio on.</p>
				<div class='input-group callout'>
					<span class='input-group-label'>
						<strong>Cost : </strong>
						<span class='label'>".(float)$gets['points']."</span>
					</span>
					<input class='input-group-field' type='text' name='torrent_ide' size='10' maxlength='10'>
					<div class='input-group-button'>".$exchange."</div>
				</div>
			</form>
		</div>
  ...
  $HTMLOUT .="<div class='column column-block'>
		<div class='card-divider'>
			...
			<span class='badge alert-info float-right'>
		...
		<div class='reveal' id='collapse".(int)$gets['id']."' data-reveal>
			<form action='{$INSTALLER09['baseurl']}/mybonus.php?exchange=1' method='post'>
				<input type='hidden' name='option' value='".(int)$gets['id']."'>
				<input type='hidden' name='art' value='".htmlsafechars($gets['art'])."'>
				<p>".htmlsafechars($gets['description'])."".$top_donator."<br />Enter the <b>amount to contribute</b></p>
				<div class='input-group callout'>
					<span class='input-group-label'>
						<strong>Min : </strong>
						<span class='label'>".(float)$gets['minpoints']."</span>
					</span>
					<input class='input-group-field' type='text' name='donate' size='10' maxlength='10'>
					<div class='input-group-button'>".$contribute."</div>
				</div>			
			</form>
		</div>
	</div>";
  ...
  $HTMLOUT .="<div class='column column-block'>
		...
		<form action='{$INSTALLER09['baseurl']}/mybonus.php?exchange=1' method='post'>
			<input type='hidden' name='option' value='".(int)$gets['id']."'>
			<input type='hidden' name='art' value='".htmlsafechars($gets['art'])."'>
			".htmlsafechars($gets['description'])."".$top_donator2."<br />Enter the <b>amount to contribute</b>
				<div class='input-group callout'>
					<span class='input-group-label'>
						<strong>Min : </strong>
						<span class='label'>".(float)$gets['minpoints']."</span>
  ...
  $HTMLOUT .="<div class='column column-block'>
		...
		<div class='reveal' id='collapse".(int)$gets['id']."' data-reveal>
			...
			<input type='hidden' name='option' value='".(int)$gets['id']."'>
			<input type='hidden' name='art' value='".htmlsafechars($gets['art'])."'>		
			<p>".htmlsafechars($gets['description'])."".$top_donator3."Enter the <b>amount to contribute</b></p>
				<div class='input-group callout'>
					<span class='input-group-label'>
						<strong>Min : </strong>
						<span class='label'>".(float)$gets['minpoints']."</span>
  ...
  $HTMLOUT .="<div class='column column-block'>
		...
		<div class='reveal' id='collapse".(int)$gets['id']."' data-reveal>
			<form action='{$INSTALLER09['baseurl']}/mybonus.php?exchange=1' method='post'>
				<input type='hidden' name='option' value='".(int)$gets['id']."'>
				<input type='hidden' name='art' value='".htmlsafechars($gets['art'])."'>
				<p>".htmlsafechars($gets['description'])." Enter the <b>ID number of the Torrent</b> you would like to bump.</p>
				<div class='input-group callout'>
					<span class='input-group-label'>
						<strong>Cost : </strong>
						<span class='label'>".(float)$gets['points']."</span>
					</span>
					<input class='input-group-field' type='text' name='torrent_id' size='4' maxlength='8'>
					<div class='input-group-button'>".$exchange."</div>
				</div>
			</form>
		</div>
  ...
  default:
	$HTMLOUT .="<div class='column column-block'>
		...
		<div class='reveal' id='collapse".(int)$gets['id']."' data-reveal>
			<form action='{$INSTALLER09['baseurl']}/mybonus.php?exchange=1' method='post'>	
				<input class='input-group-field' type='hidden' name='option' value='".(int)$gets['id']."'>
				<input class='input-group-field' type='hidden' name='art' value='".htmlsafechars($gets['art'])."'>	
				<h4 class='text-underline'><strong>".htmlsafechars($gets["bonusname"])."</strong></h4>
				<p>".htmlsafechars($gets['description'])."</p>
				<hr>
				<div class='input-group callout'>
