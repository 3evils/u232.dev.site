...
void config::init() {
	...
	// MySQL
	add("mysql_db", "09source");
	add("mysql_host", "localhost");
	add("mysql_username", "root");
	add("mysql_password", "richmond1");

	// Site communication
	add("site_host", "127.0.0.1");
	add("site_path", "");
	add("site_password", "FZKU2wWVpqcWqvMXo4lLJYgwR2Dah4UI");
	add("report_password", "FZKU2wWVpqcWqvMXo4lLJYgwR2Dah4UI");
