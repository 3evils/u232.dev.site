...
$HTMLOUT .= "
	<ul class='{$design['tabs']}'>
                <li class='{$design['tabs_title']}'><a href='tv_guide.php?country=US'>USA TV Schedule</a></li>
                <li class='{$design['tabs_title']}'><a href='tv_guide.php?country=GB'>UK TV Schedule</a></li>
                <li class='{$design['tabs_title']}'><a href='tv_guide.php?country=FR'>France TV Schedule</a></li>
                <li class='{$design['tabs_title']}'><a href='tv_guide.php?country=IE'>Ireland TV Schedule</a></li>
                <li class='{$design['tabs_title']}'><a href='tv_guide.php?country=SE'>Sweden TV Schedule</a></li>
                <li class='{$design['tabs_title']}'><a href='tv_guide.php?country=DE'>Germany TV Schedule</a></li>
		</ul>
";
...
foreach ($tvsched as $key => $item){
        $airimg = ($item['show']['image']['original']!='') ? "<img src='".$item['show']['image']['original']."'></img>":"<img src='" .$INSTALLER09['pic_base_url']."/noposter.png' style='width:214; height:305px;'></img>";
			//episode info    		
