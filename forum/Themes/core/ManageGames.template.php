...
function template_manage_games_uninstall_confirm()
{
	...
	echo '
				...
				<tr class="windowbg2">
					<td align="right">
						<input type="submit" name="save" value="', $context['confirm_button'], '" />
					</td>
				</tr>
			</table>
		</div>
...
function template_manage_games_upload()
{
	...
	<form action="', $scripturl, '?action=admin;area=managegames;sa=upload2" method="post" accept-charset="', $context['character_set'], '" enctype="multipart/form-data">
		<div class="tborder">
			<h3 class="catbg3 headerpadding">', $txt['arcade_upload'], '</h3>
			<div class="windowbg2 smallpadding">
				<input type="file" size="48" name="attachment[]" /><br />
				<input type="file" size="48" name="attachment[]" /><br />
				<input type="file" size="48" name="attachment[]" /><br />

				<span class="smalltext">', $txt['post_max_size'], ': ', $context['post_max_size'], ' MB</span>
				<div style="text-align: right">
					<input type="submit" name="upload" value="', $txt['arcade_upload_button'], '" />
				</div>
			</div>
		</div>
...
function template_edit_game_above()
{
	...
	<form action="', $scripturl, '?action=admin;area=managegames;sa=edit2" method="post">
		...
		<div class="tborder">
			<table class="bordercolor" border="0" cellpadding="4" cellspacing="1" width="100%">
				<tr class="titlebg">
					<td colspan="3">', $context['game']['name'], '</td>
				</tr>';
	...
	echo '
							<tr>
								<td align="right" colspan="2">
									<input type="submit" name="save" value="', $txt['arcade_save'], '" /><br />
