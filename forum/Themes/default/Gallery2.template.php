...
<tr class="catbg">
		...
		if ($g_manage)
		{
			...
			<a href="' . $scripturl . '?action=admin;area=gallery;sa=adminset">' . $txt['gallery_text_settings'] . '</a>&nbsp';
...
function template_image_listing()
{
	...
	<tr  class="catbg">
		<td align="center" colspan="' . $maxrowlevel . '" class="catbg"><span class="left"></span>' . @$context['gallery_cat_name'] . '</td>
			</tr>
			</tbody>';
...
echo '</td>
  ...
  <tr>
    <td width="28%" height="22" class="windowbg2" align="right"><span class="gen"><b>' . $txt['gallery_form_icon'] . '</b>&nbsp;</span></td>
...
echo '</td>
  ...
  <tr>
    <td width="28%" height="22" class="windowbg2" align="right"><span class="gen"><b>' . $txt['gallery_form_icon'] . '</b>&nbsp;</span></td>
    <td width="72%" height="22" class="windowbg2"><input type="text" name="image" size="64" maxlength="100" value="' . $context['gallery_cat_edit']['image'] . '" /></td>
  </tr>
  <tr>
    <td width="28%" colspan="2" height="26" align="center" class="windowbg2">
...
function template_search_results()
{
	...
	<tr  class="catbg">
		<td align="center" colspan="' . $maxrowlevel . '" class="catbg"><span class="left"></span>' . $txt['gallery_searchresults'] . '</td>
					</tr>
					</tbody>';
...
function template_myimages()
{
	...
	<tr  class="catbg">
		<td align="center" colspan="' . $maxrowlevel . '" class="catbg"><span class="left"></span>' . $context['gallery_usergallery_name'] . '</td>
					</tr>
					</tbody>';
	...
	foreach($context['gallery_my_images'] as $row)
	{
			...
			echo '<td align="center"><a href="' . $scripturl . '?action=gallery;sa=view;pic=' . $row['id_picture'] . '">
			<img ' . ($GD_Installed == true ?  'src="' . $modSettings['gallery_url'] . $row['thumbfilename'] . '" ' : 'src="' . $modSettings['gallery_url'] . $row['filename'] . '" height="78" width="120" alt="" ')  . ' border="0" /></a><br />';
			if($id_member == $userid)
			{
				if($row['approved'] == 1)
