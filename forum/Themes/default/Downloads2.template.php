...
Copyright 2009-2011 SMFHacks.com
...
function template_mainview()
{
	...
	if (!empty($cat))
	{
		...
		ShowTopDownloadBar($context['downloads_cat_name']);
		...
		<tr class="catbg">';
			...
			{
				echo  '<th scope="col" class="smalltext"><a href="' . $scripturl . '?action=downloads;cat=' . $cat . ';start=' . $context['start'] . ';sortby=title;orderby=' . $neworder . '">',$txt['downloads_cat_title'], '</a></th>';
				$count++;
			}

			if (!empty($modSettings['down_set_t_rating']) && $context['downloads_cat_norate'] != 1)
			{
				echo '<th scope="col" class="smalltext"><a href="' . $scripturl . '?action=downloads;cat=' . $cat . ';start=' . $context['start'] . ';sortby=mostrated;orderby=' . $neworder . '">', $txt['downloads_cat_rating'], '</a></th>';
				$count++;
			}

			if (!empty($modSettings['down_set_t_views']))
			{
				echo '<th scope="col" class="smalltext"><a href="' . $scripturl . '?action=downloads;cat=' . $cat . ';start=' . $context['start'] . ';sortby=mostview;orderby=' . $neworder . '">', $txt['downloads_cat_views'], '</a></th>';
				$count++;
			}
			...
			{
				echo '<th scope="col" class="smalltext"><a href="' . $scripturl . '?action=downloads;cat=' . $cat . ';start=' . $context['start'] . ';sortby=mostdowns;orderby=' . $neworder . '">', $txt['downloads_cat_downloads'] , '</a></th>';
				$count++;
			}

			if (!empty($modSettings['down_set_t_filesize']))
			{
				echo '<th scope="col" class="smalltext"><a href="' . $scripturl . '?action=downloads;cat=' . $cat . ';start=' . $context['start'] . 'sortby=filesize;orderby=' . $neworder . '">',$txt['downloads_cat_filesize'], '</a></th>';
				$count++;
			}

			if (!empty($modSettings['down_set_t_date']))
			{
				echo '<th scope="col" class="smalltext"><a href="' . $scripturl . '?action=downloads;cat=' . $cat . ';start=' . $context['start'] . ';sortby=date;orderby=' . $neworder . '">',$txt['downloads_cat_date'], '</a></th>';
				$count++;
			}

			if (!empty($modSettings['down_set_t_comment']))
			{
				echo '<th scope="col" class="smalltext"><a href="' . $scripturl . '?action=downloads;cat=' . $cat . ';start=' . $context['start'] . ';sortby=mostcom;orderby=' . $neworder . '">',$txt['downloads_cat_comments'],'</a></th>';
				$count++;
			}

			if (!empty($modSettings['down_set_t_username']))
			{
				echo '<th scope="col" class="smalltext"><a href="' . $scripturl . '?action=downloads;cat=' . $cat . ';start=' . $context['start'] . ';sortby=membername;orderby=' . $neworder . '">',$txt['downloads_cat_membername'],'</a></th>';
				$count++;
			}
			...
			{
				echo '<th scope="col" class="smalltext">',$txt['downloads_cat_options'],'</th>';
				$count++;
			}
	...
	else
	{
		...
		ShowTopDownloadBar($txt['downloads_text_title']);
...
<tr class="catbg">
				...
				<th scope="col" class="smalltext' . ($g_manage ? '' : ' last_th') . '" align="center">', $txt['downloads_text_totalfiles'], '</th>
				';
		if	($g_manage)
			echo '
	...
	<tr  class="catbg">
		<td align="center"  class="catbg"><span class="left"></span>' . $txt['downloads_stats_title'] . '</td>
					</tr>
					</tbody>
					<tr class="windowbg2">
	...
	<tr  class="catbg">
		<td align="center"  class="catbg"><span class="left"></span>
					' . $txt['downloads_text_adminpanel'] . '</td>
				</tr>
				</tbody>
				<tr class="windowbg2">
			...
			if (allowedTo('manage_permissions'))
				echo '<a href="', $scripturl, '?action=admin;area=permissions">', $txt['downloads_text_permissions'], '</a>';
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
    <td width="28%"  class="windowbg2" align="right"><span class="gen"><b>' . $txt['downloads_form_title'] .'</b>&nbsp;</span></td>
    <td width="72%"  class="windowbg2"><input type="text" name="title" size="64" maxlength="100" /></td>
  </tr>
  <tr>
    <td width="28%"  class="windowbg2" align="right"><span class="gen"><b>' . $txt['downloads_text_parentcategory'] .'</b>&nbsp;</span></td>
  ...
  <tr>
    ...
    <td width="72%"  class="windowbg2"><textarea rows="6" name="description" cols="54"></textarea>';
...
echo '</td>
  ...
  <tr>
    <td width="28%"  class="windowbg2" align="right"><span class="gen"><b>' . $txt['downloads_form_icon'] . '</b>&nbsp;</span></td>
    <td width="72%"  class="windowbg2"><input type="text" name="image" size="64" maxlength="100" /></td>
  </tr>
   <tr>
    <td width="28%"  class="windowbg2" align="right"><span class="gen"><b>' . $txt['downloads_form_uploadicon'] . '</b>&nbsp;</span></td>
...
echo '
  ...
  <tr>
    <td width="28%"  class="windowbg2" align="right"><span class="gen"><b>' .   $txt['downloads_text_cat_disableratings'] . '</b>&nbsp;</span></td>
    <td width="72%"  class="windowbg2"><input type="checkbox" name="disablerating" /></td>
  </tr>
  <tr>
    <td width="28%"  class="windowbg2" align="right"><span class="gen"><b>' .   $txt['downloads_txt_sortby']  . '</b>&nbsp;</span></td>
  ...
  <tr>
    <td width="28%"  class="windowbg2" align="right"><span class="gen"><b>' .   $txt['downloads_txt_orderby'] . '</b>&nbsp;</span></td>
    <td width="72%"  class="windowbg2"><select name="orderby">
  ...
  <tr>
    <td width="28%"  class="windowbg2" align="right"><span class="gen"><b>' . $txt['downloads_text_boardname'] . '</b>&nbsp;</span></td>
    <td width="72%"  class="windowbg2">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
    <td width="28%"  class="windowbg2" align="right"><span class="gen"><b>', $txt['downloads_form_title'], '</b>&nbsp;</span></td>
    <td width="72%"  class="windowbg2"><input type="text" name="title" size="64" maxlength="100" value="', $context['down_catinfo']['title'], '" /></td>
  </tr>
    <tr>
    <td width="28%"  class="windowbg2" align="right"><span class="gen"><b>', $txt['downloads_text_parentcategory'], '</b>&nbsp;</span></td>
    <td width="72%"  class="windowbg2"><select name="parent">
  ...
  <tr>
    <td width="28%"  valign="top" class="windowbg2" align="right"><span class="gen"><b>' . $txt['downloads_form_description'] . '</b>&nbsp;</span><br />' . $txt['downloads_text_bbcsupport'] . '</td>
    <td width="72%"  class="windowbg2"><textarea rows="6" name="description" cols="54">' . $context['down_catinfo']['description'] . '</textarea>';
...
echo '</td>
  ...
  <tr>
    <td width="28%"  class="windowbg2" align="right"><span class="gen"><b>' . $txt['downloads_form_icon'] . '</b>&nbsp;</span></td>
    <td width="72%"  class="windowbg2"><input type="text" name="image" size="64" maxlength="100" value="' . $context['down_catinfo']['image'] . '" /></td>
  </tr>
   <tr>
    <td width="28%"  class="windowbg2" align="right"><span class="gen"><b>' . $txt['downloads_form_uploadicon'] . '</b>&nbsp;</span></td>
    <td width="72%"  class="windowbg2">';
...
echo '
  <tr>
    <td width="28%"  class="windowbg2" align="right"><span class="gen"><b>' .   $txt['downloads_form_filenameicon'] . '</b>&nbsp;</span></td>
    <td width="72%"  class="windowbg2">' . $context['down_catinfo']['filename'] .  '&nbsp;<a href="' . $scripturl . '?action=downloads;sa=catimgdel&id=' . $context['down_catinfo']['ID_CAT'] . '">' . $txt['downloads_rep_deletefile'] . '</a></td>
  </tr>';
	...
	echo '
	  <tr>
	    <td width="28%"  class="windowbg2" align="right"><span class="gen"><b>' .   $txt['downloads_text_cat_disableratings'] . '</b>&nbsp;</span></td>
	    <td width="72%"  class="windowbg2"><input type="checkbox" name="disablerating" ' . ($context['down_catinfo']['disablerating'] ? ' checked="checked"' : '') . ' /></td>
	  </tr>
  <tr>
    <td width="28%"  class="windowbg2" align="right"><span class="gen"><b>' .   $txt['downloads_txt_sortby']  . '</b>&nbsp;</span></td>
    <td width="72%"  class="windowbg2"><select name="sortby">
			...
			if ($modSettings['down_set_file_showrating'])
				if ($modSettings['down_show_ratings'] == true && $context['downloads_file']['disablerating'] == 0)
				{
					...
					else
					{
						...
						echo $txt['downloads_form_rating'] . GetStarsByPrecent($rating)  . ' ' . $txt['downloads_form_ratingby'] .$context['downloads_file']['totalratings'] . $txt['downloads_form_ratingmembers'] . '<br />';
					}
	...
	if ($context['downloads_file']['allowcomments'])
	{
		...
		foreach ($context['downloads_comments'] as $i => $comment)
		{
			...
			if ($comment['real_name'] != '')
				echo '<a href="' . $scripturl . '?action=profile;u=' . $comment['id_member'] . '">'  . $comment['real_name'] . '</a><br />
...
<br />
<b>Has the Downloads System helped you?</b> Then support the developers:<br />
	...
	<table border="0" width="80%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		...
		<tr class="windowbg">
			...
			<table cellspacing="0" cellpadding="10" border="0" align="center" width="90%" class="table_grid">
				<thead>
			<tr class="catbg">
				<th scope="col" class="smalltext first_th">', $txt['downloads_rep_filelink'], '</th>
				<th scope="col" class="smalltext">', $txt['downloads_rep_comment'], '</th>
				<th scope="col" class="smalltext">', $txt['downloads_app_date'], '</th>
				<th scope="col" class="smalltext">', $txt['downloads_rep_reportby'], '</th>
				<th scope="col" class="smalltext last_th">', $txt['downloads_text_options'], '</th>
				</tr>
				</thead>
				';
	...
	<table border="0" width="80%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		...
		echo '
			...
			<tr class="catbg">
				...
				<th scope="col" class="smalltext first_th">' . $txt['downloads_rep_filelink'] . '</th>
				<th scope="col" class="smalltext">' . $txt['downloads_rep_org_comment']  . '</th>
				<th scope="col" class="smalltext">' . $txt['downloads_rep_comment']  . '</th>
				<th scope="col" class="smalltext">' . $txt['downloads_app_date'] . '</th>
				<th scope="col" class="smalltext">' . $txt['downloads_rep_reportby'] . '</th>
				<th scope="col" class="smalltext last_th">' . $txt['downloads_text_options'] . '</th>
...
function template_search_results()
{
	...
	ShowTopDownloadBar($txt['downloads_searchresults']);
	...
	$count = 0;
		...
		<tr class="catbg">';
			...
			if (!empty($modSettings['down_set_t_title']))
			{
				echo  '<th scope="col" class="smalltext">', $txt['downloads_cat_title'], '</th>';
				$count++;
			}

			if (!empty($modSettings['down_set_t_rating']))
			{
				echo '<th scope="col" class="smalltext">', $txt['downloads_cat_rating'], '</th>';
				$count++;
			}

			if (!empty($modSettings['down_set_t_views']))
			{
				echo '<th scope="col" class="smalltext">', $txt['downloads_cat_views'], '</th>';
				$count++;
			}
			...
			if (!empty($modSettings['down_set_t_downloads']))
			{
				echo '<th scope="col" class="smalltext">', $txt['downloads_cat_downloads'] , '</th>';
				$count++;
			}

			if (!empty($modSettings['down_set_t_filesize']))
			{
				echo '<th scope="col" class="smalltext">',$txt['downloads_cat_filesize'], '</th>';
				$count++;
			}

			if (!empty($modSettings['down_set_t_date']))
			{
				echo '<th scope="col" class="smalltext">',$txt['downloads_cat_date'], '</th>';
				$count++;
			}

			if (!empty($modSettings['down_set_t_comment']))
			{
				echo '<th scope="col" class="smalltext">',$txt['downloads_cat_comments'],'</th>';
				$count++;
			}

			if (!empty($modSettings['down_set_t_username']))
			{
				echo '<th scope="col" class="smalltext">',$txt['downloads_cat_membername'],'</th>';
				$count++;
			}
...
function template_myfiles()
{
	...
	ShowTopDownloadBar($context['downloads_userdownloads_name']);
	...
	foreach ($context['downloads_files'] as $i => $file)
	{
		...
		echo '
				...
				if ($g_add)
					echo '<a href="' . $scripturl . '?action=downloads;sa=add">' . $txt['downloads_text_adddownload'] . '</a> - ';
...
function template_filelist()
{
	...
	<table border="0" width="80%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		<tr class="titlebg">
			<td>' . $txt['downloads_filespace_list_title'] . ' - ' . $context['downloads_filelist_real_name'] . '</td>
		</tr>
		<tr class="windowbg">
			<td>
			<table cellspacing="0" cellpadding="10" border="0" align="center" width="90%" class="tborder">
...
<thead>	
<tr class="catbg">
				<th scope="col" class="smalltext first_th">' . $txt['downloads_filespace_groupname'] . '</th>
				<th scope="col" class="smalltext">' . $txt['downloads_text_category']  . '</th>
				<th scope="col" class="smalltext">' .  $txt['downloads_perm_view']  . '</th>
				<th scope="col" class="smalltext">' .  $txt['downloads_perm_add']  . '</th>
				<th scope="col" class="smalltext">' .  $txt['downloads_perm_edit']  . '</th>
				<th scope="col" class="smalltext">' .  $txt['downloads_perm_delete']  . '</th>
				<th scope="col" class="smalltext">' .  $txt['downloads_perm_addcomment']  . '</th>
				<th scope="col" class="smalltext last_th">' .  $txt['downloads_text_options']  . '</th>
				</tr>
				</thead>';
...
function downloads_copyright()
{
	...
	echo '<div align="center"><!--Link must remain or contact me to pay to remove.--><span class="smalltext">Powered by: <a href="http://www.smfhacks.com" target="_blank">Download System</a> by <a href="http://www.createaforum.com" title="Forum Hosting">CreateAForum.com</a></span><!--End Copyright link--></div>';
