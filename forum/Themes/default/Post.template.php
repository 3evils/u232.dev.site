...
function template_main()
{
	...
	echo '
					<div id="postMoreOptions" class="smalltext">
						<ul class="post_options">
							...
							', $user_info['is_admin'] ? '<li><label for="check_hide_edit"><input type="checkbox" name="hide_modify" id="check_hide_edit" class="input_check" /> ' . $txt['hide_edit'] . '</label></li>' : '', '
	...
	echo '
					</fieldset><p class="information centertext">
						', $context['browser']['is_firefox'] ? $txt['shortcuts_firefox'] : $txt['shortcuts'], '
					</p>
					<p id="post_confirm_buttons" class="centertext">
