...
$txt['Adkseffect_desc'] = '
	Esta aplicación nos permitira poner un efecto de nieve en nuestro sitio.
	<br /><b>Opciones:</b>
	<br />&nbsp;&nbsp;&#8226; Activar/desactivar el mod.
	<br />&nbsp;&nbsp;&#8226; Elegir color de la nieve
	<br />&nbsp;&nbsp;&#8226; Cambiar el diseño de la nieve.
	<br />&nbsp;&nbsp;&#8226; Cambiar la velocidad de la nieve.
	<br />&nbsp;&nbsp;&#8226; Activar/desactivar la acumulacion de nieve al pie de página.
	<br />&nbsp;&nbsp;&#8226; Activar/desactivar el movimiento de la nieve en dirección al mouse.
';
$txt['enable_adk_snow_effect'] = '<strong>Activar</strong> <strong style="color:red">Adk Snow Effect</strong>:';
$txt['ADK_SeStick'] = '<strong>Desactivar Acumulación de nieve</strong>:';
$txt['ADK_SeMouse'] = '<strong>Desactivar Seguimiento de Mouse</strong>:';
$txt['ADK_Secolor'] = '<strong>Cambiar el color de la nieve</strong>:';
$txt['ADK_SeChart'] = '<strong>Cambiar el diseño de la nieve</strong>:';
...
$txt['Adk_efChart_bull'] = 'Diseño: &bull;';
$txt['Adk_efChart_middot'] = 'Diseño: &middot;';
$txt['Adk_efChart_curren'] = 'Diseño: &curren;';
$txt['Adk_efChart_times'] = 'Diseño: &times;';
$txt['Adk_efChart_ast'] = 'Diseño: *';
...
$txt['Adk_efColor_maroon'] = 'Marrón';
$txt['Adk_efColor_brown'] = 'Marrón Oscuro';
$txt['Adk_efColor_beige'] = 'Marrón Claro';
?>