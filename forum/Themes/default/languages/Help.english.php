...
/* What's this? LOLz I DonT NO wUT UR tAlkING 'bout.
$helptxt['karmaSendPMContents'] = 'In addition to BBC and smileys being allowed in the PM, there are a built-in few variables that can be used in the PM which will automatically be
		substituted with the appropriate information. These are:<br />
		<table style="border: 2px solid;">
			<tr>
				<td><span style="font-weight: bold; text-align: left;">Variable</span> -> </td>
				<td><span style="font-weight: bold; text-align: right;">Value</span></td>
			</tr>
			<tr>
				<td><span style="text-align: left;">{sender}</span></td>
				<td><span style="text-align: right;">The sender\'s display name</span></td>
			</tr>
			<tr>
				<td><span style="text-align: left;">{posneg}</span></td>
				<td><span style="text-align: right;">Depending on which it is, "positive" or "negative"</span></td>
			</tr>
			<tr>
				<td><span style="text-align: left;">{receiever}</span></td>
				<td><span style="text-align: right;">The receiver\'s display name</span></td>
			</tr>
			<tr>
				<td><span style="text-align: left;">{comment}</span></td>
				<td><span style="text-align: right;">The reputation comment left by {sender}</span></td>
			</tr>
		</table>';*/
