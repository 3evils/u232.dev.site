...
function SnowStorm() {
  ...
  this.followMouse = ADK_SeMouse;   // Snow will change movement with the user's mouse
  this.snowColor = ADK_Secolor;     // Don't eat (or use?) yellow snow.
  this.snowCharacter = ADK_SeChart; // &bull; = bullet, &middot; is square on some systems etc.
  this.snowStick = ADK_SeStick;     // Whether or not snow should "stick" at the bottom. When off, will never collect.
  ...
  this.vMaxX = ADK_SeVelox;         // Maximum X velocity range for snow
  this.vMaxY = ADK_SeVeloy;         // Maximum Y velocity range
