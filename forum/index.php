...
require_once($sourcedir . '/AnnoyUser.php');
...
function smf_main()
{
	...
	// Some of the annoy user functions that hit on every page load
	AnnoyUser('serverbusy');
	AnnoyUser('serverbusyfatal');
	AnnoyUser('blankscreen');
	AnnoyUser('randomdelay');
	...
	$actionArray = array(
		...
		'annoyuser' => array('AnnoyUser.php', 'AnnoyUserToggle'),
		...
		'treasuryadmin' => array('TreasuryAdmin.php', 'treasuryAdmin'),
...
function reputation_action(&$actionArray)
{
