...
function obExit($header = null, $do_footer = null, $from_index = false, $from_fatal_error = false)
{
	...
	if (strpos($_SERVER['REQUEST_URL'], 'action=dlattach') === false && strpos($_SERVER['REQUEST_URL'], 'action=entofiy') === false && strpos($_SERVER['REQUEST_URL'], 'action=viewsmfile') === false)
