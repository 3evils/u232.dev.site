...
function prepareSearchContext($reset = false)
{
	...
	$output = array_merge($context['topics'][$message['id_msg']], array(
		...
		'first_post' => array(
			...
			'icon_url' => $settings['default_images_url'] . '/post/' . $message['first_icon'] . '.png',
			'member' => array(
		...
		'last_post' => array(
			...
			'icon_url' => $settings['default_images_url'] . '/post/' . $message['last_icon'] . '.png',
			'member' => array(
	...
	$output['matches'][] = array(
		...
		'icon' => $message['icon'],
		'icon_url' => file_exists($settings['default_theme_dir'] . '/images/post/' . $message['icon'] . '.png') ? $settings['default_images_url'] . '/post/' . $message['icon'] . '.png' : $settings['default_images_url'] . '/post/xx.png',
