...
function setupMenuContext()
{
	...
	$context['allow_calendar'] = allowedTo('calendar_view') && !empty($modSettings['cal_enabled']);	$context['allow_arcade'] = allowedTo('arcade_view') && !empty($modSettings['arcadeEnabled']);
		...
		$buttons = array(
			...
			'admin' => array(
				...
				'sub_buttons' => array(
					...
					'CustomizedProfile' => array(
						'title' => !empty($txt['CP_title']) ? $txt['CP_title'] : 'Customized Profile',
						'href' => $scripturl . '?action=admin;area=CustomizedProfile',
						'show' => allowedTo('admin_forum'),
						'is_last' => true,
					),
				),
