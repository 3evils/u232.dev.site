	...
	*/
	$permissionList = array(
		'membergroup' => array(
			...
			'view_treasury' => array(false, 'treasury', 'view_basic_info'),
...
function reputation_permissions(&$permissionGroups, &$permissionList, &$leftPermissionGroups, &$hiddenPermissions, &$relabelPermissions)
{
	$permissionList['membergroup']['disable_karma_display'] = array(false, 'general', 'moderate_general');
	$permissionList['membergroup']['positive_karma'] = array(false, 'general', 'moderate_general');
	$permissionList['membergroup']['negative_karma'] = array(false, 'general', 'moderate_general');
	$permissionList['membergroup']['delete_karma'] = array(false, 'general', 'moderate_general');
}
