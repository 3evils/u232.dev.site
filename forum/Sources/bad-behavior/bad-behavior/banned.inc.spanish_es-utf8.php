...
require_once(BB2_CORE . "/responses.inc.spanish_es-utf8.php");
...
<p>Su clave de soporte técnico es: <strong><?php echo $support_key; ?></strong></p>
...
<p>Si no consigue solucionar el problema usted mismo, por favor contacte <a href="<?php echo bb2_email_scramble(); ?>"><?php echo bb2_email_to(); ?></a> y asegúrese de proporcionar la clave de soporte técnico que aparece arriba.</p>
<?php
// Bad Behavior for SMF start
global $modSettings;
...
if ($modSettings['badbehavior_email_allow']) {
	...
	$emailbody .= " Explicación: ".$response['explanation']."\n\r";
