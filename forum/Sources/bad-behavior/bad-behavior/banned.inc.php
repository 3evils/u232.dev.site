...
<p>You can use this key to <a href="http://www.ioerror.us/bb2-support-key?key=<?php echo $support_key; ?>">fix this problem yourself</a>.</p><?php echo $honeyLink; ?>
<p>If you are unable to fix the problem yourself, please contact <a href="<?php echo bb2_email_scramble(); ?>"><?php echo bb2_email_to(); ?></a> and be sure to provide the technical support key shown above.</p>
<?php
// Bad Behavior for SMF start
global $modSettings;
...
if ($modSettings['badbehavior_email_allow']) {
	...
	$emailsubject = "Bad Behavior Mod for SMF has zapped some spam!";
	$emailbody = " Bad Behavior Mod has just blocked some spam.\n\r";
	$emailbody .= " Support key: ".$support_key."\n\r";
	$emailbody .= " Error ".$response['response']."\n\r";
	$emailbody .= " for ".htmlspecialchars($request_uri)."\n\r";
	$emailbody .= " Explanation: ".$response['explanation']."\n\r";
	$emailbody .= " Logged as: ".$response['log']."\n\r";
