...
function Post()
{
	...
	<style type="text/css">
		.icons, #bbcBox_message, #smileyBox_message {text-align: center;}
		.icons fieldset, #event_main, #event_options, #addOptions {
			border-radius: 5px;
		...
		.input_icons, .input_icons:focus {border-style: none; background-color: inherit;}
	</style>';
	...
	{
		$context['icon_url'] = $settings['default_images_url'] . '/post/' . $context['icon'] . '.png';
