		...
		while ($row = $smcFunc['db_fetch_assoc']($result))
		{
			...
			$context['topics'][$row['id_topic']] = array(
				...
				'first_post' => array(
					...
					'icon' => $row['first_icon'],
					'icon_url' => file_exists($settings['default_theme_dir'] . '/images/post/' . $row['first_icon'] . '.png') ? $settings['default_images_url'] . '/post/' . $row['first_icon'] . '.png' : $settings['default_images_url'] . '/post/xx.png',
				...
				'last_post' => array(
					...
					'icon' => $row['last_icon'],
					'icon_url' => file_exists($settings['default_theme_dir'] . '/images/post/' . $row['last_icon'] . '.png') ? $settings['default_images_url'] . '/post/' . $row['last_icon'] . '.png' : $settings['default_images_url'] . '/post/xx.png',
