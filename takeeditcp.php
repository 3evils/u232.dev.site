...
elseif ($action == "personal") {
    ...
    if (isset($_POST['shoutboxbg']) && (($shoutboxbg = (int)$_POST['shoutboxbg']) != $CURUSER['shoutboxbg']) && is_valid_id($shoutboxbg)) {
        $updateset[] = 'shoutboxbg = ' . sqlesc($shoutboxbg);
        $curuser_cache['shoutboxbg'] = $shoutboxbg;
        $user_cache['shoutboxbg'] = $shoutboxbg;
    }
    $snow = (isset($_POST['snow']) && $_POST['snow'] === 'yes' ? 'yes' : 'no'); {
        $updateset[] = "snow = ".sqlesc($snow);
        $curuser_cache['snow'] = $snow;
        $user_cache['snow'] = $snow;
    }
