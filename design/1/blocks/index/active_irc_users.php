...
$active_irc_users = '<div class="card">
	<div class="card-divider portlet-header">
		<label for="checkbox_4" class="text-left">' . $lang['index_active_irc'] . '&nbsp;&nbsp;<span class="badge success disabled" style="color:#fff">' . $active_irc_users_cache['actcount'] . '</span></label>
	</div>
	<div class="cotent portlet-content card-section">
			  <p>' . $active_irc_users_cache['activeircusers'] . '</p>
			 </div></div>';
