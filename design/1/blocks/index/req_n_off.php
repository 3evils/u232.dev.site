...
$HTMLOUT.="<div class='card'>
	<div class='card-divider portlet-header'>{$lang['req_off_label']}</div>
	<div class='portlet-content card-section'>";
//== Requests
/*$HTMLOUT.="<ul class='accordion' data-accordion disabled>
  <li class='accordion-item is-active' data-accordion-item>
  <a href='#' class='accordion-title'>{$lang['req_off_unfld']}</a>
...
if (count($requests) > 0) {
    ...
    $HTMLOUT.= "<thead>
			<tr>
				...
				<th>{$lang['req_off_com']}</th>  
				<th>{$lang['req_off_vot']}</th>
				<th>{$lang['req_off_reqby']}</th>
				<th>{$lang['req_off_fild']}</th>
			</tr>
		</thead>\n";
    if ($requests) {
...
$HTMLOUT.="<ul class='accordion' data-accordion disabled>
  <li class='accordion-item is-active' data-accordion-item>
  <a href='#' class='accordion-title'>{$lang['req_off_offers']}</a>
	<div class='accordion-content' data-tab-content>";
	*/
$offers = array();
...
if (count($offers) > 0) {
    ...
    $HTMLOUT.= " <thead><tr>
				...
				<th>{$lang['req_off_com']}</th>  
				<th>{$lang['req_off_vot']}</th>
				<th>{$lang['req_off_offd']}</th>
                <th>{$lang['req_off_stat']}</th>
                </tr></thead>\n";
    if ($offers) {
