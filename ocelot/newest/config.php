...
$INSTALLER09['mysql_pass'] = 'SXNM1xAxcPn5mws2';
...
$INSTALLER09['cookie_domain'] = 'dev.open-scene.net'; // set to eg: .somedomain.com or is subdomain set to: .sub.somedomain.com
$INSTALLER09['domain'] = '';
//== Memcache expires
...
//== XBT or PHP announce
if (XBT_TRACKER == true) {
$INSTALLER09['xbt_prefix'] = 'http://dev.open-scene.net:34000/';  
$INSTALLER09['xbt_suffix'] = '/announce';
$INSTALLER09['announce_urls'][] = 'http://dev.open-scene.net:34000/announce';
} else {
$INSTALLER09['announce_urls'] = array();
$INSTALLER09['announce_urls'][] = 'http://dev.open-scene.net/announce.php';
$INSTALLER09['announce_urls'][] = 'https://dev.open-scene.net/announce.php';
}
...
$INSTALLER09['site_email'] = 'dev@open-scene.net';
$INSTALLER09['site_name'] = "whocares Dev";
