...
$INSTALLER09['cookie_domain'] = 'u-232.dev'; // set to eg: .somedomain.com or is subdomain set to: .sub.somedomain.com
//== Memcache expires
...
$INSTALLER09['ocelot_prefix'] = 'http://u-232.dev:'.TRACKER_PORT.'/';  
$INSTALLER09['ocelot_suffix'] = '/announce';
$INSTALLER09['announce_urls'][] = 'http://u-232.dev:'.TRACKER_PORT.'/announce';
} else {
$INSTALLER09['announce_urls'] = array();
$INSTALLER09['announce_urls'][] = 'http://u-232.dev/announce.php"';
$INSTALLER09['announce_urls'][] = 'https://u-232.dev/announce.php"';
}
...
$INSTALLER09['variant'] = 'U-232 Codename Trinity';
