...
function getRate($id, $what)
{
    ...
    $completeres = sql_query("SELECT * FROM " . (OCELOT_TRACKER == true ? "xbt_files_users" : "snatched") . " WHERE " . (OCELOT_TRACKER == true ? "completedtime !=0" : "complete_date !=0") . " AND " . (OCELOT_TRACKER == true ? "uid" : "userid") . " = " . $CURUSER['id'] . " AND " . (OCELOT_TRACKER == true ? "fid" : "torrentid") . " = " . $id);
