...
WHERE type = "crazyhour"') or sqlerr(__FILE__, __LINE__);
            ...
            $text_parsed = '<b class="small button success">Next <span style="font-weight:bold;color:orange;">Crazyhour</span> is at ' . get_date($crazyhour['crazyhour']['var'] + ($CURUSER['time_offset'] - 3600) , 'LONG');
...
WHERE type = "crazyhour"') or sqlerr(__FILE__, __LINE__);
        ...
        $htmlout.= '<li>
<a class="sa-tooltip" href="#"><b class="small button success">' . $lang['gl_crazy_on'] . '<span class="custom info alert alert-success text-left">
' . $crazytitle . '...<br />' . $crazymessage . ' <br /> ' . ' ' . $lang['gl_crazy_ends'] . ' ' . mkprettytime($crazyhour['remaining']) . '&nbsp;' . $lang['gl_crazy_at'] . ' ' . get_date($crazyhour['crazyhour']['var'], 'LONG') . '</span></b></a></li>';
    ...
    $htmlout.= '<li>
<a class="sa-tooltip" href="#"><a class="small button success">' . $lang['gl_crazy_'] . '</b>
