...
if(($halfdownload_counter = $mc1->get_value('halfdownload_counter_alerts_')) === false) {
   ...
   $htmlout .="
  <a href='./mybonus.php'><button class='button small success' type='button' data-toggle='example-dropdown-1'>Karma Contribution's</button>
  <div class='dropdown-pane' id='example-dropdown-1' data-dropdown data-hover='true' data-hover-pane='true'>Freeleech&nbsp;[&nbsp;";
            if($freeleech_enabled){
