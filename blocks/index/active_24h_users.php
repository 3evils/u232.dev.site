...
$last_24 = '<div class="card">
	<div class="card-divider portlet-header">
		<label for="checkbox_4" class="text-left">' . $lang['index_active24'] . ' <span class="badge success disabled" style="color:#fff">' . $last24_cache['totalonline24'] . '</span> ' . $lang['index_last24_list'] . '</label>
	</div>
