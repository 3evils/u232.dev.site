...
//$mc1->delete_value('rec_tor_');
	...
	<div class='panel-heading'><label class='text-left'>{$lang['index_rec_tor']}</label></div>
        <div class='container-fluid panel-body'><div style='height:300px;width:100%;overflow-y:scroll;overflow-x:hidden;'><table style='margin-top:;'><tr>";
    if ($rec_torrents)
    {
