...
//    $htmlout_snatch .= "<tr><td class='one' align='right' valign='top'><b>{$lang['userdetails_snatched']}</b></td><td class='one'>";
    $htmlout_snatch .= "<table class='responsive-card-table unstriped'>
	<thead>
		<tr>
			<th>{$lang['userdetails_s_cat']}</th>
			<th>{$lang['userdetails_s_torr']}</th>" . "
			<th>{$lang['userdetails_s_sl']}</th>
			<th>{$lang['userdetails_s_up']}" . ($INSTALLER09['ratio_free'] ? "" : "{$lang['userdetails_s_down']}") . "</td>
...
if ($CURUSER['class'] >= UC_STAFF) {
    ...
    $HTMLOUT .= "<div class='row'><ul class='accordion' data-accordion data-allow-all-closed='true'>
		  <li class='accordion-item' data-accordion-item>
			<a href='#' class='accordion-title'>{$lang['userdetails_snatched']} of {$count_snatched_staff}<font color='red'><b>{$lang['userdetails_s_staff']}</b></font></a>
