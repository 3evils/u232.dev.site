...
if ($top5torrents) {
        ...
        if (empty($top5torrents)) $HTMLOUT.= "<tbody><tr><td  colspan='5'>{$lang['top5torrents_no_torrents']}</td></tr></tbody></table></div></div>";
    }
}
//==Last 5 begin
...
<td class='text-center'><span class='badge'>$thealth</td>             
        ...
        //== If there are no torrents
        if (empty($last5torrents)) $HTMLOUT.= "<tbody><tr><td colspan='5'>{$lang['last5torrents_no_torrents']}</td></tr></tbody></table></div></div>";
    }
}
$HTMLOUT.= "</div></div>";
