...
<span class='nav navbar-nav navbar-right'><a class='btn btn-primary btn-sm navbar-btn' style='margin-right:20px;margin-top:-2px;' href='{$INSTALLER09['baseurl']}/staffpanel.php?tool=staff_shistory'>{$lang['index_shoutbox_history']}</a></span>
</div>
...
if (!($CURUSER['opt2'] & user_options_2::SHOW_STAFFSHOUT)) {
    $HTMLOUT.= "<fieldset class='header'><legend><b>{$lang['index_staff_shoutbox']}&nbsp;</b></legend></fieldset>";
