...
<!-- Template CSS-->
    	<link rel="stylesheet" href="templates/2/2.css" />
	...
	// design changer function
	//================================================== -->
        function design() {
          window.open('take_design.php','My design','height=150,width=200,resizable=no,scrollbars=no,toolbar=no,menubar=no');
        }
  ...
  if ($CURUSER) {
   ...
   <div class='container'>
    ...
    require_once (DESIGN_DIR.''. $CURUSER['design'].'/blocks/global/staff_tools.php');
    }
    }
    if ($CURUSER) {
