...
function tabs_start()
{
	return "<ul class='tabs' data-active-collapse='true' data-tabs id='myTab'>";
}
function tabs_title($tabs_title)
{
	return "<li class='tabs-title'>$tabs_title</li>";
}
function tabs_title_active($tabs_title_active)
{
	return "<li class='tabs-title is-active'>$tabs_title_active</li>";
}
